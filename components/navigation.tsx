        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              ...
              >
                ...
                {pathname === item.href && (
                  <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-primary/20 to-primary/10 rounded-full animate-pulse" />
                )}
                <div className="absolute inset-0 bg-primary/0 group-hover:bg-primary/5 rounded-full transition-all duration-300" />
              </Link>
            ))}
            ...
            <div className="ml-4 pl-4 border-l border-border/50 flex items-center space-x-2">
              ...
              >
                ...
                <div className="absolute inset-0 bg-current/20 rounded-full blur-md group-hover:blur-lg transition-all duration-300 opacity-0 group-hover:opacity-100" />
              </Button>

              {/* Tombol Login Admin */}
              <Link href="/admin/login">
                <Button className="bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-900/50 dark:to-gray-800/50" variant="outline" size="sm" onClick={() => setLoading(false)}>
                  Login
                </Button>
              </Link>
            </div>
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <Button
              ...
              className="rounded-full bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-900/50 dark:to-gray-800/50 hover:bg-primary/10 transition-all duration-300"
            >
              {isOpen ? (
            ...
            {navItems.map((item, i) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${pathname === item.href
                      ? "bg-primary"
